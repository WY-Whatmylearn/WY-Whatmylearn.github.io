...
vlog -work xil_defaultlib -64 -incr -sv -L axi_vip_v1_1_4 -L processing_system7_vip_v1_0_6 -L smartconnect_v1_0 -L xilinx_vip "+incdir+F:/Xilinx/Vivado/2018.3/data/xilinx_vip/include" \
...
vlog -work fifo_generator_v13_2_3 -64 -incr "+incdir+F:/Xilinx/Vivado/2018.3/data/xilinx_vip/include" \
...
vlog -work xil_defaultlib -64 -incr "+incdir+F:/Xilinx/Vivado/2018.3/data/xilinx_vip/include" \
