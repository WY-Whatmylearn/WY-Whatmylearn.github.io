...
proc create_root_design { parentCell } {
  ...
  # Create instance: AXI_VIP_Frame_Differ_0, and set properties
  set block_name AXI_VIP_Frame_Difference
  set block_cell_name AXI_VIP_Frame_Differ_0
  if { [catch {set AXI_VIP_Frame_Differ_0 [create_bd_cell -type module -reference $block_name $block_cell_name] } errmsg] } {
     catch {common::send_msg_id "BD_TCL-105" "ERROR" "Unable to add referenced block <$block_name>. Please add the files for ${block_name}'s definition into the project."}
     return 1
   } elseif { $AXI_VIP_Frame_Differ_0 eq "" } {
  ...
  connect_bd_intf_net -intf_net AXI_VIP_Frame_Differ_0_m_axis [get_bd_intf_pins AXI_VIP_Frame_Differ_0/m_axis] [get_bd_intf_pins axi_vdma_1/S_AXIS_S2MM]
  ...
  connect_bd_intf_net -intf_net axi_vdma_0_M_AXIS_MM2S [get_bd_intf_pins AXI_VIP_Frame_Differ_0/s1_axis] [get_bd_intf_pins axi_vdma_0/M_AXIS_MM2S]
  ...
  connect_bd_intf_net -intf_net axis_broadcaster_0_M00_AXIS [get_bd_intf_pins AXI_VIP_Frame_Differ_0/s0_axis] [get_bd_intf_pins axis_broadcaster_0/M00_AXIS]
  connect_bd_intf_net -intf_net axis_broadcaster_0_M01_AXIS [get_bd_intf_pins axi_vdma_0/S_AXIS_S2MM] [get_bd_intf_pins axis_broadcaster_0/M01_AXIS]
